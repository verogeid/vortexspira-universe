...
export function _mostrarDetalle(cursoId) {
    ...
    if (isMobile) appInstance.STATE.keyboardNavInProgress = false;
    ...
    // Contenido dinámico (fragmentos y acciones)
    ...
    // CORRECCIÓN: Asegurar tabindex="0" para la Vista-Volver fija
    ...
    if (target) {
        const tryFocus = (el, att) => {
            ...
            } else setTimeout(() => tryFocus(el, att - 1), 50);
        };
