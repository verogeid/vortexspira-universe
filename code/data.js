...
export async function loadData() {
    try {
        ...
        debug.logError('data', "No se pudo cargar 'cursos.json'", e);
        throw e;
    }
}
        ...
        footerContent.innerHTML = `
            ...
            <div class="footer-social-container">
                <a href="${LINKEDIN_URL}" target="_top" 
                    aria-label="${App.getString('ariaLinkedIn')}" class="footer-social-link link-linkedin">
                </a>

                <a href="${DEV_DIARY_URL}" target="_blank" 
                    aria-label="GitHub Dev Diary" class="footer-social-link link-github">
                </a>

                <a href="${LANDING_PAGE_URL}" target="_top" 
                    aria-label="Landing Page" class="footer-social-link link-fire">
                </a>
            </div>
