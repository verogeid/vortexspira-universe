...
const LANDING_PAGE_URL = "https://subscribepage.io/vortexspira";
const DEV_DIARY_URL = "https://github.com/verogeid/vortexspira";
...
// (Esta se queda aquí, como bien dijiste, para el favicon y el header)
function createVortexSpiraSVG(primaryColor, accentColor = SECONDARY_COLOR, className = '') {
    // ... (Contenido del SVG de VortexSpira sin cambios) ...
...
// ⭐️ 5. FUNCIÓN DE INYECCIÓN DE FOOTER (MODIFICADA) ⭐️

/**
 * ❌ ELIMINADO: createLinkedInSVG() ya no es necesaria.
 */

/**
 * Inyecta el contenido HTML dinámico en el footer.
 * ⭐️ MODIFICADO: Ya no inyecta el SVG de LinkedIn.
 */
function injectFooterContent() {
    const footerContent = document.getElementById('footer-content');
    
    // ❌ ELIMINADO: const linkedInSvg = createLinkedInSVG();
