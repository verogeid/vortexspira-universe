...
const SVG_TRIANGLE = `<svg class="triangulo-svg" viewBox="0 0 100 86.6">
        <defs>
        ...
        <path 
            d="M 10 86.6 L 90 86.6 Q 100 86.6 100 76.6 L 57 10 Q 50 0 43 10 L 0 76.6 Q 0 86.6 10 86.6 Z" 
            fill="transparent" 
            stroke="currentColor"           /* Borde hereda el color del texto del botón */
            stroke-width="2"
            stroke-linejoin="round"
            stroke-linecap="round"
            vector-effect="non-scaling-stroke"
            filter="url(#ghostShadow)"      /* Aplica el filtro de sombra al path */
        />
    </svg>`;
...
// ⭐️ MODIFICADO: Clases para ocultar en móvil ⭐️
